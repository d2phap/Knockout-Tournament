...
describe('Tournament', function() {
  ...
  const getNumberOfTeamsFromRounds = numberOfRounds => Math.pow(config.TEAMS_PER_MATCH, numberOfRounds);
  ...
  it('selects the correct winner of a single match tournament', function() {
    this.timeout(5000);
    const numberOfTeams = getNumberOfTeamsFromRounds(1);
  ...
  it('selects the correct winner of a 4 round tournament', function() {
    ...
    const numberOfTeams = getNumberOfTeamsFromRounds(numberOfRounds);
